...
public interface RewardNetwork {
	 ...
	 * @param transactionId unique identifier for the Dining to be stored with the reward
	 * @return confirmation of the reward
	 */
	public RewardConfirmation rewardAccountFor(Dining dining, String transactionId);
}