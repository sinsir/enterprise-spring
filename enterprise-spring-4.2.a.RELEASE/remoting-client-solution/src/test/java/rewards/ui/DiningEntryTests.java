...
public class DiningEntryTests {
	...
	public void testValidDiningEntry() throws IOException {
		...
		// now create in instance of the class we want to test, and provide the mock dependency
		...
		// emulate the Lifecycle callback that will be received from the Spring container
		diningEntry.start();
