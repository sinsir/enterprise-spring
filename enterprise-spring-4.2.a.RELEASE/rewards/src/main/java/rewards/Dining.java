...
public class Dining implements Serializable {
	 ...
	 * @return the dining event
	 */
	public static Dining createDining(String amount, String creditCardNumber, String merchantNumber, Date date) {
		return new Dining(MonetaryAmount.valueOf(amount), creditCardNumber, merchantNumber, SimpleDate.valueOf(date));
	}
